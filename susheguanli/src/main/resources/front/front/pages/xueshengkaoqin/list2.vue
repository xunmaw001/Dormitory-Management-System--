	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <button
                    ...
                    v-if="isAuth('xueshengkaoqin','新增')" @click="onAddTap()" class="uniui-add">新增</button>
		</view>
	</view>
	<view style="">
...
<script>
	export default {
		...
		async onShow() {
            ...
            this.categoryList = xueshengkaoqinTypes.data.list
				...
				let params = {
                    ...
                    xueshengId:this.userId,//查询自己的
							...
							if (this.categoryName != 0) {
                                params.xueshengkaoqinTypes = this.categoryName
                            }
            ...
            wuyong(id) {
                ...
                uni.showModal({ content: '确定要 么?',title: '提示',
                    success: async function(res) {
                        if (res.confirm) {
                            await _this.$api.update(`xueshengkaoqin`, {
                                id:id,
                            });
