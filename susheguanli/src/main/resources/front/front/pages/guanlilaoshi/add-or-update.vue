    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">管理老师姓名</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"var(--publicSubColor)","color":"#fff","textAlign":"left","borderRadius":"20rpx 0","borderWidth":"0 10rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.guanlilaoshiName" type="text" v-model="ruleForm.guanlilaoshiName" placeholder="管理老师姓名"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">管理老师手机号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"var(--publicSubColor)","color":"#fff","textAlign":"left","borderRadius":"20rpx 0","borderWidth":"0 10rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.guanlilaoshiPhone" type="text" v-model="ruleForm.guanlilaoshiPhone" placeholder="管理老师手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">管理老师身份证号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"var(--publicSubColor)","color":"#fff","textAlign":"left","borderRadius":"20rpx 0","borderWidth":"0 10rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.guanlilaoshiIdNumber" type="text" v-model="ruleForm.guanlilaoshiIdNumber" placeholder="管理老师身份证号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="guanlilaoshiPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">管理老师头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.guanlilaoshiPhoto" :src="baseUrl+ruleForm.guanlilaoshiPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">管理老师邮箱</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"var(--publicSubColor)","color":"#fff","textAlign":"left","borderRadius":"20rpx 0","borderWidth":"0 10rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.guanlilaoshiEmail" type="text" v-model="ruleForm.guanlilaoshiEmail" placeholder="管理老师邮箱"></input>
            </view>
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
    ...
    export default {
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`guanlilaoshi`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.guanlilaoshiId){
                this.ruleForm.guanlilaoshiId = options.guanlilaoshiId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.guanlilaoshiName)) {
                    this.$utils.msg(`管理老师姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.guanlilaoshiPhone) && (!this.$validate.isMobile(this.ruleForm.guanlilaoshiPhone))) {
                    this.$utils.msg(`管理老师手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.guanlilaoshiIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.guanlilaoshiIdNumber))) {
                    this.$utils.msg(`管理老师身份证号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.guanlilaoshiPhoto)) {
                    this.$utils.msg(`管理老师头像不能为空`);
                    return
                }
				...
				if ((!this.ruleForm.guanlilaoshiEmail) && (!this.$validate.isEmail(this.ruleForm.guanlilaoshiEmail))) {
                    this.$utils.msg(`管理老师邮箱不能为空并且需要输入正确格式`);
                    return
                }
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`guanlilaoshi`, this.ruleForm);
                } else {
                    await this.$api.save(`guanlilaoshi`, this.ruleForm);
                }
