                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/susheguanli/upload/susheXueshengMuBan.xls"
                        >批量导入宿舍成员数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('susheXuesheng','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'sushe_xuesheng',//当前表表名,
                        sumColum : 'sushe_xuesheng_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'sushe_xuesheng_name',//分组字符串字段
                        // types : 'sushe_xuesheng_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
