    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="考勤结果" prop="xueshengkaoqinTypes">
                        <el-select v-model="ruleForm.xueshengkaoqinTypes" :disabled="ro.xueshengkaoqinTypes" placeholder="请选择考勤结果">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="考勤结果" prop="xueshengkaoqinValue">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengkaoqin_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
