    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修编号" prop="baoxiuUuidNumnber">
                       <el-input v-model="ruleForm.baoxiuUuidNumnber"
                                 placeholder="报修编号" clearable  :readonly="ro.baoxiuUuidNumnber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修编号" prop="baoxiuUuidNumnber">
                           <el-input v-model="ruleForm.baoxiuUuidNumnber"
