            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '考勤结果' : ''">
                        <el-select v-model="searchForm.xueshengkaoqinTypes" placeholder="请选择考勤结果">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/susheguanli/upload/xueshengkaoqinMuBan.xls"
                        >批量导入学生考勤数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xueshengkaoqin','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'xueshengkaoqin',//当前表表名,
                        sumColum : 'xueshengkaoqin_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'xueshengkaoqin_name',//分组字符串字段
                        // types : 'xueshengkaoqin_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
            ...
            getDataList() {
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=xueshengkaoqin_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
