    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="susheId" name="susheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="宿舍卫生编号" prop="susheweishengUuidNumnber">
                       <el-input v-model="ruleForm.susheweishengUuidNumnber"
                                 placeholder="宿舍卫生编号" clearable  :readonly="ro.susheweishengUuidNumnber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="宿舍卫生编号" prop="susheweishengUuidNumnber">
                           <el-input v-model="ruleForm.susheweishengUuidNumnber"
                                     placeholder="宿舍卫生编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="卫生状态" prop="susheweishengTypes">
                        <el-select v-model="ruleForm.susheweishengTypes" :disabled="ro.susheweishengTypes" placeholder="请选择卫生状态">
                            <el-option
                                v-for="(item,index) in susheweishengTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="卫生状态" prop="susheweishengValue">
                        <el-input v-model="ruleForm.susheweishengValue"
                            placeholder="卫生状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.riqiTime"  class="input" label="所属日期" prop="riqiTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.riqiTime" label="所属日期" prop="riqiTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.susheweishengContent"  label="卫生详情" prop="susheweishengContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.susheweishengContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.susheweishengContent" label="卫生详情" prop="susheweishengContent">
                            <span v-html="ruleForm.susheweishengContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    susheId: '',
                    susheweishengUuidNumnber: new Date().getTime(),
                    susheweishengTypes: '',
                    dafen: '',
                    riqiTime: '',
                ...
                rules: {
                   ...
                   susheweishengUuidNumnber: [
                              { required: true, message: '宿舍卫生编号不能为空', trigger: 'blur' },
                          ],
                   susheweishengTypes: [
                              { required: true, message: '卫生状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   susheweishengContent: [
                              { required: true, message: '卫生详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=susheweisheng_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.susheweishengTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.susheweishengContent = _this.ruleForm.susheweishengContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.susheweishengContent = this.ruleForm.susheweishengContent.replaceAll(this.$base.url,"");
                        this.$http({
