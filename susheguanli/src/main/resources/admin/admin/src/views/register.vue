    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">宿舍管理系统小程序注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="管理老师姓名" class="input" v-if="tableName=='guanlilaoshi'">
                            <el-input v-model="ruleForm.guanlilaoshiName" autocomplete="off" placeholder="管理老师姓名"  />
                        </el-form-item>
                        <el-form-item label="管理老师手机号" class="input" v-if="tableName=='guanlilaoshi'">
                            <el-input v-model="ruleForm.guanlilaoshiPhone" autocomplete="off" placeholder="管理老师手机号"  />
                        </el-form-item>
                        <el-form-item label="管理老师身份证号" class="input" v-if="tableName=='guanlilaoshi'">
                            <el-input v-model="ruleForm.guanlilaoshiIdNumber" autocomplete="off" placeholder="管理老师身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="guanlilaoshiPhotoFlag">
                            </el-form-item>
                            <el-form-item label="管理老师头像" class="input" v-if="tableName=='guanlilaoshi'">
                                    <file-upload
                                        tip="点击上传管理老师头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="管理老师邮箱" class="input" v-if="tableName=='guanlilaoshi'">
                            <el-input v-model="ruleForm.guanlilaoshiEmail" autocomplete="off" placeholder="管理老师邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="账户状态" class="input" v-if="tableName=='guanlilaoshi'">
                                <el-input v-model="ruleForm.jinyongTypes" autocomplete="off" placeholder="账户状态"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='guanlilaoshi'">
                        ...
                        <!--
                            <el-form-item label="账户状态" class="input" v-if="tableName=='xuesheng'">
                                <el-input v-model="ruleForm.jinyongTypes" autocomplete="off" placeholder="账户状态"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                guanlilaoshiPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            guanlilaoshiPhotoUploadChange(fileUrls) {
               this.ruleForm.guanlilaoshiPhoto = fileUrls;
                if(this.guanlilaoshiPhotoFlag){
                    this.guanlilaoshiPhotoFlag=false;
                }else{
                    this.guanlilaoshiPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            if((!this.ruleForm.guanlilaoshiName)&& 'guanlilaoshi'==this.tableName){
                                this.$message.error('管理老师姓名不能为空');
                                return
                            }
                             if('guanlilaoshi' == this.tableName && this.ruleForm.guanlilaoshiPhone&&(!this.$validate.isMobile(this.ruleForm.guanlilaoshiPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.guanlilaoshiIdNumber)&& 'guanlilaoshi'==this.tableName){
                                this.$message.error('管理老师身份证号不能为空');
                                return
                            }
                            // guanlilaoshi 中的 管理老师头像 判空处理
                            // if('guanlilaoshi' == this.tableName && (this.ruleForm.guanlilaoshiPhoto== null ||this.ruleForm.guanlilaoshiPhoto== "")){
                            //     this.$message.error("管理老师头像不能为空");
                            //     return
                            // }
                            if('guanlilaoshi' == this.tableName && this.ruleForm.guanlilaoshiEmail&&(!this.$validate.isEmail(this.ruleForm.guanlilaoshiEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // guanlilaoshi 中的 账户状态 判空处理
                            // if('guanlilaoshi' == this.tableName && (this.ruleForm.jinyongTypes== null ||this.ruleForm.jinyongTypes== "")){
                            //     this.$message.error("账户状态不能为空");
                            //     return
                            // }
                            // guanlilaoshi 中的 创建时间 判空处理
                            // if('guanlilaoshi' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/susheguanli/img/back-img-bg.jpg);
