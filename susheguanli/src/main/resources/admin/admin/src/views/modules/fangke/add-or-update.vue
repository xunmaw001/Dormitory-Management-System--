                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.fangkePhoto" label="健康码" prop="fangkePhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.fangkePhoto?$base.url+ruleForm.fangkePhoto:''"
                            @change="fangkePhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.fangkePhoto" label="健康码" prop="fangkePhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.fangkePhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
