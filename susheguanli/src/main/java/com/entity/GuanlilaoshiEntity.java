...
public class GuanlilaoshiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public GuanlilaoshiEntity() {

	}

	public GuanlilaoshiEntity(T t) {
		try {
     ...
     * 管理老师姓名
     */
    @ColumnInfo(comment="管理老师姓名",type="varchar(200)")
     ...
     * 管理老师手机号
     */
    @ColumnInfo(comment="管理老师手机号",type="varchar(200)")
     ...
     * 管理老师身份证号
     */
    @ColumnInfo(comment="管理老师身份证号",type="varchar(200)")
     ...
     * 管理老师头像
     */
    @ColumnInfo(comment="管理老师头像",type="varchar(200)")
     ...
     * 管理老师邮箱
     */
    @ColumnInfo(comment="管理老师邮箱",type="varchar(200)")
    ...
    public String toString() {
        return "Guanlilaoshi{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", guanlilaoshiName=" + guanlilaoshiName +
            ", guanlilaoshiPhone=" + guanlilaoshiPhone +
            ", guanlilaoshiIdNumber=" + guanlilaoshiIdNumber +
            ", guanlilaoshiPhoto=" + guanlilaoshiPhoto +
            ", sexTypes=" + sexTypes +
            ", guanlilaoshiEmail=" + guanlilaoshiEmail +
